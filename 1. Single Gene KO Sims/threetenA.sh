...
#SBATCH --array=1-252 	
# Name of Job
#SBATCH --job-name=threetenA
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/threetenA/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/threetenA -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/threetenA/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/threetenA -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/threetenA/figs {} +
