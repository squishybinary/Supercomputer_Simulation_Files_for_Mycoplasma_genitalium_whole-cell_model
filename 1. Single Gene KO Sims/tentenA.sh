...
#SBATCH --array=1-252 	
# Name of Job
#SBATCH --job-name=tentenA
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/tentenA/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/tentenA -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/tentenA/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/tentenA -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/tentenA/figs {} +
