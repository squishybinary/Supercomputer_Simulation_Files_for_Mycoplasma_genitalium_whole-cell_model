...
#SBATCH --array=1-111 	
# Name of Job
#SBATCH --job-name=tentenB
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/tentenB/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/tentenB -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/tentenB/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/tentenB -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/tentenB/figs {} +
