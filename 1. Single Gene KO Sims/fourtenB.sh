...
#SBATCH --array=1-111 	
# Name of Job
#SBATCH --job-name=fourtenB
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/fourtenB/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/fourtenB -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/fourtenB/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/fourtenB -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/fourtenB/figs {} +
