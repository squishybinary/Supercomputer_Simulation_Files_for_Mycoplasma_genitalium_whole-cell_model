...
#SBATCH --array=1-111 	
# Name of Job
#SBATCH --job-name=twotenB
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/twotenB/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/twotenB -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/twotenB/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/twotenB -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/twotenB/figs {} +
