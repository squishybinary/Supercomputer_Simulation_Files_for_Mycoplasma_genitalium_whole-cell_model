...
#OutDir, inside OutDir: /figs, /pdfs folders AND/NOT endtimes.txt. Create the /experiment folders from exp.list. Create simulation folders for the number of simulations in /OutDir/Experiment.
...
#SBATCH --array=1-252 	
# Name of Job
#SBATCH --job-name=seventenA
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/seventenA/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/seventenA -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/seventenA/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/seventenA -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/seventenA/figs {} +
