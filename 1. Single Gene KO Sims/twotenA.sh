...
#SBATCH --array=1-252 	
# Name of Job
#SBATCH --job-name=twotenA
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/twotenA/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/twotenA -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/twotenA/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/twotenA -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/twotenA/figs {} +
