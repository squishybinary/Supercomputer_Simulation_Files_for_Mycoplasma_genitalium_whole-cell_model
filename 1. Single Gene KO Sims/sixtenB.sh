...
#SBATCH --array=1-111 	
# Name of Job
#SBATCH --job-name=sixtenB
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/sixtenB/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/sixtenB -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/sixtenB/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/sixtenB -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/sixtenB/figs {} +
