...
#SBATCH --array=1-252 	
# Name of Job
#SBATCH --job-name=fourtenA
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/fourtenA/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/fourtenA -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/fourtenA/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/fourtenA -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/fourtenA/figs {} +
