...
#SBATCH --array=1-12 	
# Name of Job
#SBATCH --job-name=GeneKnockoutSimulation
# Location of Log Output
#SBATCH --output=/projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation/slurm-%A_%a.out
...
OutDir=/projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation

# Experimental Variables
Experiment='GeneKnockoutSimulation'
...
# Extract simulation number from supercomputer 
Sim=${SLURM_ARRAY_TASK_ID}

# Project Name
Umbrella=GeneKnockoutSimulation
# Change the outputted filenames based on the project name
CustomEndTimeName=GeneKnockoutSimulation_e
...
# find /projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation -type f -iname "*.pdf" -exec mv -t /projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation/pdfs {} +
# find /projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation -type f -iname "*.fig" -exec mv -t /projects/flex1/USER/output/PROJECTFOLDER/GeneKnockoutSimulation/figs {} +
