...
#SBATCH --array=1-38 	
# Name of Job
#SBATCH --job-name=mg412check
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/mg412check/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check/figs {} +
