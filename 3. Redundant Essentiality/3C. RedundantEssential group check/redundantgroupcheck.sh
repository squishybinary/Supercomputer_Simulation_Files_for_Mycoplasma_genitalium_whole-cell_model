...
#SBATCH --array=1-77 	
# Name of Job
#SBATCH --job-name=redundantgroupcheck
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/redundantgroupcheck_exp.list

Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/redundantgroupcheck_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/redundantgroupcheck/figs {} +
