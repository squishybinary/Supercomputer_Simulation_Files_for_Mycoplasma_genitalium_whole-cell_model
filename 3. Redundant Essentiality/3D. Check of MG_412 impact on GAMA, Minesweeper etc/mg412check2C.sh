...
#SBATCH --array=1-130 	
# Name of Job
#SBATCH --job-name=mg412check2C
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/mg412check2C/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper/mg412check2C

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/mg412check2C_exp.list

Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/mg412check2C_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check2C -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check2C/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check2C -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check2C/figs {} +
