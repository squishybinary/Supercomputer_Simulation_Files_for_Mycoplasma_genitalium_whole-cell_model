...
#SBATCH --array=1-130 	
# Name of Job
#SBATCH --job-name=mg412check2
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/mg412check2/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check2 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check2/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/mg412check2 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/mg412check2/figs {} +
