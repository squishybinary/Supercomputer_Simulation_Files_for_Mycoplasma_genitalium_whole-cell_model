...
#SBATCH --array=1-200
# Name of Job
#SBATCH --job-name=figure3
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/figure3_exp.list
Umbrella=figure3
...
ko_list=/home/jr0904/BlueGem/KOLists/figure3_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3/figs {} +
