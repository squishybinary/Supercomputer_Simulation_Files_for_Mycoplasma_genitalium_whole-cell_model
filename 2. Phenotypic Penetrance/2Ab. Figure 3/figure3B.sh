...
#SBATCH --array=1-100
# Name of Job
#SBATCH --job-name=figure3B
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/figure3B_exp.list
Umbrella=figure3B
...
ko_list=/home/jr0904/BlueGem/KOLists/figure3B_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/figure3B/figs {} +
