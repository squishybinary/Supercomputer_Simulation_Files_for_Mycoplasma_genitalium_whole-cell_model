...
#SBATCH --array=1-54 	
# Name of Job
#SBATCH --job-name=Sets2
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/Sets2/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/Sets2 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/Sets2/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/Sets2 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/Sets2/figs {} +
