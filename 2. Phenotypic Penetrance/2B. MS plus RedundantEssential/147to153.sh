...
#SBATCH --array=1-21 	
# Name of Job
#SBATCH --job-name=147to153
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/147to153/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/147to153 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/147to153/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/147to153 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/147to153/figs {} +
