...
#SBATCH --array=1-32 	
# Name of Job
#SBATCH --job-name=145to147
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to147/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to147 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to147/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to147 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to147/figs {} +
