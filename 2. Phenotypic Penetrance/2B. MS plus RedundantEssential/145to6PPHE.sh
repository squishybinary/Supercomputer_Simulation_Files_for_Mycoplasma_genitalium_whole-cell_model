...
#SBATCH --array=1-250
# Name of Job
#SBATCH --job-name=145to6PPHE
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/145to6PPHE_exp.list
Umbrella=145to6PPHE
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}
CustomEndTimeName=PP_e
# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/145to6PPHE_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/145to6PPHE/figs {} +
