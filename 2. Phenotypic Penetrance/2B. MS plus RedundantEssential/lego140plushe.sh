...
#SBATCH --array=1-26 	
# Name of Job
#SBATCH --job-name=lego140plushe
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/lego140plushe_exp.list
Umbrella=lego140plushe
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/lego140plushe_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plushe/figs {} +
