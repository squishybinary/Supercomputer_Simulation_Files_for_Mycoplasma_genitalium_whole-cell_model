...
#SBATCH --array=1-54 	
# Name of Job
#SBATCH --job-name=Sets2C
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/Sets2C/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/Sets2C -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/Sets2C/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/Sets2C -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/Sets2C/figs {} +
