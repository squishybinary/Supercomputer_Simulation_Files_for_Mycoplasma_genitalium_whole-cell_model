...
#SBATCH --array=1-12 	
# Name of Job
#SBATCH --job-name=lego140plusle
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/lego140plusle_exp.list
Umbrella=lego140plusle
Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/lego140plusle_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper_SI_Data/5_Lego_plus_RedundantEssential_singles/lego140plusle/figs {} +
