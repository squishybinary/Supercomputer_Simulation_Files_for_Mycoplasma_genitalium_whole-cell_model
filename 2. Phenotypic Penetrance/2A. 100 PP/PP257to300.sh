...
#SBATCH --array=1-44 	
# Name of Job
#SBATCH --job-name=PP257to300
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/PP257to300/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/PP257to300 -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/PP257to300/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/PP257to300 -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/PP257to300/figs {} +
