...
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/PP/slurm-%A_%a.out
...
# find /projects/flex1/jr0904/output/MGS_Paper/PP -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/PP/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/PP -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/PP/figs {} +
