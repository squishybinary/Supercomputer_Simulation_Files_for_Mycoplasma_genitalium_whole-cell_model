...
#SBATCH --array=1-102 	
# Name of Job
#SBATCH --job-name=onesixfive_check
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/onesixfive_check/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper/onesixfive_check

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/onesixfive_check_exp.list

Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/onesixfive_check_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper/onesixfive_check -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/onesixfive_check/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/onesixfive_check -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/onesixfive_check/figs {} +
