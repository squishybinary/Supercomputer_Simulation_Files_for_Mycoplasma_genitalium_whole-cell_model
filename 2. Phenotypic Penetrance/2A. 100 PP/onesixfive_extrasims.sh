...
#SBATCH --array=1-102 	
# Name of Job
#SBATCH --job-name=onesixfive_extrasims
# Location of Log Output
#SBATCH --output=/projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims/slurm-%A_%a.out
...
OutDir=/projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims

# Variables passed to analysis
# Fetch the Experiment name from the Exp list file
experiment_list=/home/jr0904/BlueGem/ExpLists/onesixfive_extrasims_exp.list

Experiment=$(awk NR==${SLURM_ARRAY_TASK_ID} ${experiment_list})
Sim=${SLURM_ARRAY_TASK_ID}

# Fetch the Gene Knock Outs from the KO list file
ko_list=/home/jr0904/BlueGem/KOLists/onesixfive_extrasims_ko.list
...
# find /projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims -type f -iname "*.pdf" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims/pdfs {} +
# find /projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims -type f -iname "*.fig" -exec mv -t /projects/flex1/jr0904/output/MGS_Paper/onesixfive_extrasims/figs {} +
